...
import 'package:cuboverse/cubits/settings.dart';
import 'package:cuboverse/helpers/theme_mode.dart';
import 'package:cuboverse/theme.dart';
...
class PersonalizationOptionsView extends StatelessWidget {
  const PersonalizationOptionsView({super.key});
              ...
              children: [
                ...
                if (!kIsWeb &&
                    (Platform.isWindows ||
                        Platform.isLinux ||
                        Platform.isMacOS))
                  BlocBuilder<SettingsCubit, CuboverseSettings>(
